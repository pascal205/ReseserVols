...
<div class="w-100">
    ...
    <div class="hero-card p-4 mt-3">
        <h6 class="mb-3"><i class="fas fa-calendar me-2 text-primary"></i> Inscrit le <?= date('d/m/Y', strtotime($_SESSION['date_inscription'])) ?></h6>
        <h6 class=""><i class="fas fa-clock me-2 text-primary"></i> Dernière connexion: <?= date('d/m/Y H:i', strtotime($_SESSION['last_conexion'])) ?></h6>
    </div>
</div>